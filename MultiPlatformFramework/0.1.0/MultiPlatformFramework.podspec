#
# Be sure to run `pod lib lint MultiPlatformFramework.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => 'ssh://git@github.com/miguelcampiao/MultiPlatformFramework.git', :tag => s.version.to_s }
